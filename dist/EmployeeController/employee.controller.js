...
class EmployeeController {
    ...
    createEmployee(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const createEmployeeDto = (0, class_transformer_1.plainToInstance)(create_employee_dto_1.default, req.body);
    ...
    getEmployeeById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!employee) {
                    throw new httpException_1.default(501, "employee not found error");
                }
